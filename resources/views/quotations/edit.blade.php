...
<div class="container">
    ...
    <form action="{{ route('quotations.update', $quotation) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="client_name" id="client_name" class="form-control" value="{{ $quotation->client_name }}" required>
        </div>
        <div class="mb-3">
            <label for="client_email" class="form-label">Email del Cliente</label>
            <input type="email" name="client_email" id="client_email" class="form-control" value="{{ $quotation->client_email }}" required>
        </div>
        <div class="mb-3">
            <label for="client_phone" class="form-label">Teléfono del Cliente</label>
            <input type="text" name="client_phone" id="client_phone" class="form-control" value="{{ $quotation->client_phone }}">
        </div>
        <div class="mb-3">
...
$(document).ready(function() {
    let selectedProducts = @json($quotation->products);
